...
notion = Client(auth="secret_dLgAsdks4uwlsATuQCtG8AAgRrSOlXfKRV0itSytVVr")

# Define the ID of the parent page where you want to create the new pages
parent_page_id = "98589cf7-dc1e-41b1-bab7-eda901361f3a"

# Define the path to the folder where the text files are located
folder_path = "G:\\My Drive\\Documents\\Python projects\\Voice Recordings\\txt files"
